        ...
        <div title="纳税人信息" data-options="closable:false" class="basic-info">
            ...
            <table class="kv-table">
                ...
                <tr>
                    ...
                    <td class="kv-content"><input type="text" readonly name="payerCode" value="${requestScope.payer.payerCode}"></td>
                    ...
                    <td class="kv-content">  
                     ...
                     <option value="-1">请选择下达部门</option>
                            <c:forEach items="${requestScope.organs }" var="organ">
                            	<option value="${organ.id }" ${organ.id == requestScope.task.subOrganId ? "selected":""}>${organ.organName }</option>
                            </c:forEach>                                             
                      </select>
					</td>
                    ...
                    <td class="kv-content">
                     ...
                     <option value="-1">请选择批准人</option>
	                      <c:forEach items="${requestScope.taxers }" var="taxer">
                             <option value="${taxer.id }" ${taxer.id == requestScope.Approver.id? "selected":""}>${taxer.taxerName }</option>
                          </c:forEach> 
	                    </select>
					</td>
                </tr>
                ...
                <tr>  
                  	...
                  	<td class="kv-content">    	
	                    ...
	                    <option value="-1">请选择执行人</option>
	                      <c:forEach items="${requestScope.taxers }" var="taxer">
	                            <option value="${taxer.id }" ${taxer.id == requestScope.Execute.id ? "selected":""}>${taxer.taxerName }</option>
	                         </c:forEach> 
	                    </select>
                 	</td>
